const { Integer, Text, Relationship } = require('@itoa/fields');
const { multiAdapterRunners, setupServer, networkedGraphqlRequest } = require('@itoa/test-utils');
  ...
  describe(`Adapter: ${adapterName}`, () => {
    describe('cache hints', () => {
      ...
      test(
        'mutations',
        runner(setupItoa, async ({ itoa, app }) => {
          const { posts } = await addFixtures(itoa);
