...
> **Note:** This is a conceptual introduction to how the Itoa team think about GraphQL APIs (and hence how Itoa's GraphQL API is generated). For more specific API docs, see the [**GraphQL API Introduction**](/docs/guides/intro-to-graphql.md).
...
Itoa's auto-generated GraphQL Schema meets these goals by following a pattern with two distinct sets of things:
