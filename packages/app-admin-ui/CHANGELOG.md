...
- [8494e4cc](https://github.com/itoa-vn/itoacommit/8494e4cc):
  ...
  `@itoa-alpha/app-admin-ui` no longer accepts a `itoa` paramater in its constructor. It is now automatically passed during the `itoa.prepare()` call.
