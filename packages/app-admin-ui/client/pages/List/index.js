...
import { captureSuspensePromises } from '@itoa/utils';
...
const ListPage = props => {
  ...
  if (hasErrorWithNoData) {
    ...
    if (message && message.startsWith('Cannot query field')) {
      message = `Không thể truy cập danh sách ${list.plural}`;
    }
