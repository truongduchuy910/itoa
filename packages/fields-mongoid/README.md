...
[the `isNotNullable` and `defaultTo` options](https://github.com/itoa-vn/itoapull/1383#issuecomment-509889242).
...
in these contexts, the string `'AF3D'` *does not equal* the string `'af3d'`.
...
[core `Uuid` field type](https://github.com/itoa-vn/itoatree/main/packages/fields/src/types/Uuid#casing).
