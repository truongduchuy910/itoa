...
[![View changelog](https://img.shields.io/badge/changelogs.xyz-Explore%20Changelog-brightgreen)](https://changelogs.xyz/@itoa/apollo-helpers)

A set of functions and components to ease using
[Apollo](https://www.apollographql.com/docs/react/) with Itoa.

## Installation

```shell
yarn add @itoa/apollo-helpers
```
...
import { Query, ItoaProvider } from '@itoa/apollo-helpers';
...
If we went with this method, we could automatically inject that directive into Itoa generated GraphQL schemas.
