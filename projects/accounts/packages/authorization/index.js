...
class Authorization {
  ...
  constructor() {
    return {
      list: this.defaultAccessList,
      field: this.defaultAccessField,
      custom: this.defaultAccessCustom,
    };
  }
  async defaultAccessList({
    authentication,
    listKey,
    operation,
    originalInput,
    ...
    //   switch (listKey) {
    //     case "User":
    //       return authentication.item ? { id: authentication.item.id } : false;
    //     default:
    //       return true;
    //   }
    // }
    ...
    //   query: gql`
    //     query(
    //       $operation: UserAccessListOperationType
    //       $listKey: String
    //       $user: ID
    //     ) {
    //       allUserAccessLists(
    //         where: {
    //           OR: [
    //             { operation: $operation, schemas_some: { name: $listKey } }
    //             {
    //               operation: $operation
    //               schemas_some: { name: $listKey }
    //               permissions_some: {
    //                 requests_some: { user: { id: $user }, status: approval }
    //               }
    //             }
    //           ]
    //         }
    ...
    //     }
    //   `,
    //   variables: { operation, listKey, user: auth.id },
    // });
    // const { allUserAccessLists = [] } = data;
    // return true;
  }
  defaultAccessField() {
    return true;
