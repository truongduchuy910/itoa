...
const LakDetail = ({
  ...
  const [currentImage, setCurrentImage] = useState(`${product?.image?.publicUrl}`);
          ...
          <div className="slider-image">
                  ...
                  <span>
                    <a className="fancybox-thumb" title="Hình chính">
                      <img
                        ...
                        src={currentImage || product?.image?.publicUrl}
                        onClick={() => {
                          setZoom(zoom => !zoom);
                        }}
                        style={
            ...
            <div id="carousel" className="flexslider">
              <div className="flex-viewport" style={{ overflow: 'hidden', position: 'relative' }}>
                ...
                >
                  {[{ file: product?.image }, ...(product?.images || [])]?.map((image, index) => {
                    return (
                      <li
                        key={index}
                        className={`product-thumb ${
                          currentImage === `${image.file?.publicUrl}` && `checked`
                        }`}
                        style={{
                          width: '48px',
                          marginRight: '10px',
                        ...
                        onClick={() => {
                          setCurrentImage(`${image.file?.publicUrl}`);
                        }}
                      >
                        <a
                          href="#"
                          data-image={`${image.file?.publicUrl}`}
                          data-zoom-image={`${image.file?.publicUrl}`}
                        >
                          <img
        ...
        <div className="col-md-6 col-sm-6 col-xs-12">
          <div className="description-product">
            <div className="info-desc">
              ...
              <div className="cate">
                Trạng thái :
                <a id="price-preview">{product?.isOutOfStock ? 'Hết hàng' : 'Còn hàng'}</a>
              </div>
              {/*  QUANTITY  */}
              <div className="mt-3">
            ...
            {!product?.isOutOfStock && (
              <div className="qty-cart row">
                <form id="form-pro" action="#" method="get" className="qty-number-cart col-6">
                                  ...
                                  >
                                    <label
                                      style={{
                                        ...
                                        textDecoration: exist ? 'underline' : 'none',
                                        color: exist && 'var(--color-text-primary)',
                                        borderColor: exist && 'var(--color-text-primary)',
                                      }}
                                    >
                                      {value.value}
                                    </label>
                    ...
                    onClick={e => {
                      addToCart(e)
                        ...
                        .catch(err => {
                          ...
                          if (graphQLErrors) onToast()(graphQLErrors[0].message);
          ...
          <Tabs className="mt-5">
            ...
            <TabPanels>
              ...
              {product?.detail?.publicUrl && (
                <TabPanel>
                  <img width="100%" src={`${product?.detail?.publicUrl}`} />
                </TabPanel>
              )}
              {product?.guide && (
                <TabPanel>
