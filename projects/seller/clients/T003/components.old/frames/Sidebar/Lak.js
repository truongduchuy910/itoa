              ...
              <nav className="nav-category navbar-toggleable-md">
                <ul className="nav navbar-pills">
                  {allProductCategories?.map(category => {
                    ...
                    return (
                      <li key={category.id} className="nav-item lv1 filter-item--green">
                        <a
                          title={category.name}
                          className="nav-link"
                          onClick={() => {
                          ...
                          style={{
                            textDecoration: cgr == category.id ? 'underline' : '',
                          }}
                        >
                          {category.name}
                        </a>
                        ...
                        <ul className="dropdown-menu" style={{ display: 'block' }}>
                          {open &&
                            category?.childs?.map(category_1 => {
                              return (
                                <li key={category_1.key} className="nav-item lv2">
                                  <a
                                    className="nav-link"
                                    ...
                                    style={{
                                      textDecoration: cgr == category_1.id ? 'underline' : '',
                                    }}
                                  >
                                    {category_1.name}
                                  </a>
