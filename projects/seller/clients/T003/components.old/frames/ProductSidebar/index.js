...
const ProductSidebar = ({
  ...
  const { loading, error, data, previousData } = useQuery(
    gql`
      query ($firstCategories: Int, $firstBrands: Int, $category: ProductCategoryWhereInput) {
        allProductCategories(first: $firstCategories, where: $category, sortBy: prioritize_DESC) {
          id
          name
          url
          prioritize
