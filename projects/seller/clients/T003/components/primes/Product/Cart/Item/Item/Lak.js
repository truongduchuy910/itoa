        ...
        <div className="modal-content">
          <div className="modal-header">
            <h4 className="modal-title ">
              <i className="fa fa-check-square-o" aria-hidden="true" /> Thêm vào giỏ thành công
            </h4>
            <button
              onClick={() => {
                onClose();
              ...
              <div className="col-sm-8 col-xs-7 imgCartDetail">
                ...
                <div className="itemCartPrice">
                  <div className="product-price">
                    <span className="p-price ">{formatMoney(sale ? sale : price)} ₫</span>
                    <del />
                  </div>
                </div>
          ...
          <div className="modal-footer">
            ...
            <button type="button" className="close viewCartPage" onClick={() => onClickCart()}>
              Xem giỏ hàng
            </button>
          </div>
        </div>
