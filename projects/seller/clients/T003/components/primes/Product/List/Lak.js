...
const Lak = ({ allProducts, _allProductsMeta, loadingMore, onClickMore, onClickProduct }) => {
          ...
          <div className="product-grid-view">
            <div className="row">
              {allProducts?.map(product => {
                return (
                  <div key={product.id} className="col-md-4 col-xs-6 img-box">
                    <div className="single-product mb-10">
                      <div className="product-img img-full">
                        {/* <label className="sign">{page.domain}</label> */}
                        ...
                        >
                          ...
                          <img
                            ...
                            src={product.image.publicUrl.replace('/img', '/img-sm')}
                            data-src={product.image.publicUrl.replace('/img', '/img-sm')}
                            alt={product.name}
                          />

                          <img
                            className="hidden-xs lazyload protmt1 "
                            src={product.image.publicUrl.replace('/img', '/img-sm')}
                            data-src={product.image.publicUrl.replace('/img', '/img-sm')}
                            alt={product.name}
                          />
                          ...
                          {product?.images?.length ? (
                            <img
                              ...
                              src={product.images[0].file.publicUrl.replace('/img', '/img-sm')}
                              alt={product.name}
                            />
                          ) : (
                            <img
                        ...
                        <div className="product-price">
                          {product.sale ? (
                            <div className="price-box">
                              <span className="price ml5">{formatMoney(product.price)} ₫</span>
                              <span className="regular-price">{formatMoney(product.sale)} ₫</span>
                            </div>
                          ) : (
                            <div className="price-box">
                              <span className="regular-price">{formatMoney(product.price)} ₫</span>
                            </div>
                          )}
                        </div>
                      </div>
      ...
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          ...
          <div className="modal-body">
            <ProductItem UI={LakDetail} quickview={true} ProductWhereInput={{ url: product.url }} />
          </div>
        </div>
        {/* /.modal-content */}
      </div>
