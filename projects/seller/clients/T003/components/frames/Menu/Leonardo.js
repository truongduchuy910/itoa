const Leonardo = () => {
  return (
    <div
      ...
      className="shopify-section shopify-section--header"
    >
            ...
            >
              <ul className="HorizontalList HorizontalList--spacingExtraLoose">
                ...
                <li className="HorizontalList__Item " aria-haspopup="true">
                  <a
                    href="https://www.leonardo.vn/collections/all/male"
                    className="Heading u-h6"
                  >
                    ...
                    <div className="MegaMenu__Inner">
                      <div className="MegaMenu__Item MegaMenu__Item--fit">
                        ...
                        <ul className="Linklist">
                          ...
                          <li className="Linklist__Item">
                            <a
                              href="/collections/vi-dai-nam/male"
                              className="Link Link--secondary"
                            >
                              Ví dài
                            </a>
                      ...
                      <div className="MegaMenu__Item MegaMenu__Item--fit">
                        ...
                        <ul className="Linklist">
                          ...
                          <li className="Linklist__Item">
                            <a
                              href="/collections/day-da-dong-ho"
                              className="Link Link--secondary"
                            >
                              Dây da đồng hồ
                            </a>
                ...
                <li className="HorizontalList__Item " aria-haspopup="true">
                  <a
                    href="https://www.leonardo.vn/collections/all/female"
                    className="Heading u-h6"
                  >
                    WOMEN<span className="Header__LinkSpacer">WOMEN</span>
                  </a>
                  <div
                    className="MegaMenu MegaMenu--spacingEvenly "
                    aria-hidden="true"
                  >
                    <div className="MegaMenu__Inner">
                      <div className="MegaMenu__Item MegaMenu__Item--fit">
                        ...
                        <ul className="Linklist">
                          ...
                          <li className="Linklist__Item">
                            <a
                              href="/collections/vi-card/female"
                              className="Link Link--secondary"
                            >
                              Ví đựng card
                            </a>
