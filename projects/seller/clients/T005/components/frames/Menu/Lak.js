...
import { chakra, Icon, Heading } from "@chakra-ui/react";
import { SearchIcon } from "@chakra-ui/icons";
import { useRouter } from "next/router";
import { SearchModal } from "@itoa/ui/Search";
function CartIcon() {
  return (
 ...
 */
const Lak = ({ allProductCategories = [], onClickAccount, page }) => {
  ...
  const [openSearch, onOpenSearch] = useState(false);
  ...
  return (
    <Fragment>
      {openSearch && (
        <SearchModal isOpen={openSearch} onClose={() => onOpenSearch(false)} />
      )}
      <header className="no-index">
        <div className="container">
          <div className="row row-ibl mid">
            ...
            <div
              className="col-12 col-md-3 centermb"
              style={{ paddingLeft: 9 }}
            >
            ...
            <div className="col text-right hidden-xs hidden-sm">
              <nav className="main-nav">
                <ul id="menu-main-menu" className="">
                      ...
                      >
                        ...
                        <ul className="sub-menu">
                          {category?.childs?.map((category_1) => {
                            // console.log(`/san-pham/${category_1.url}`);
                            return (
                              <li
                                key={category_1.id}
                                className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children"
                              >
                                <NextLink
                                  href={`/san-pham/${category_1.url}`}
                                  passHref
                                >
                                  <a title={category_1.name}>
                                    {category_1.name}
                                  </a>
                                </NextLink>
                                <ul className="sub-menu">
                                  {category_1?.childs?.map((category_2) => {
                                    // console.log(`/san-pham/${category_2.url}`);
                                    return (
                                      <li
                                        key={category_2.id}
                                      ...
                                      >
                                        <NextLink
                                          href={encodeURI(
                                            `/san-pham/${category_2.url}`,
                                          )}
                                          passHref
                                        >
                                          <a title={category_2.name}>
                                            {category_2.name}
                                          </a>
                                        </NextLink>
                                      </li>
                  ...
                  <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                    <NextLink href={`/hot-deal/`} passHref>
                      <a title={"Hot Deal"}>Hot Deal</a>
                    </NextLink>
                  </li>
                </ul>
              </nav>
              ...
              <div className="search">
                <SearchIcon
                  ...
                  fontSize={18}
                  cursor="pointer"
                  onClick={(e) => onOpenSearch(true)}
                />
                <NextLink href={`/gio-hang`}>
                  <a className="" style={{ position: "relative" }}>
                    <CartIcon />
                    {/* <img
                      src="https://theme.hstatic.net/1000319111/1000411564/14/cart-icon.png?v=1032"
                      alt="cart"
