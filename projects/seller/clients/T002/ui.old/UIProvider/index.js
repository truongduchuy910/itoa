...
function mergePageProps(initialState = {}, pageProps = {}) {
...
export async function executeInitialProps(context, initialProps, queries = []) {
  ...
  var initialState = initialProps.pageProps[APOLLO_STATE_PROP_NAME];
  ...
  initialProps.pageProps[APOLLO_STATE_PROP_NAME] = initialState;
  return initialProps;
}
