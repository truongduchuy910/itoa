...
import { Box, Link, SimpleGrid, Square } from "@chakra-ui/react";
    ...
    <Box>
      <div className="single-product mb-10">
        <div className="product-img img-full">
          <NextLink
            href={`/san-pham/${product?.categories[0]?.url || "_"}/${
              product.url
            }`}
            passHref
          >
            ...
            >
              ...
              {isOpen ? (
                <Image
                  ...
                  src={encodeURI(product.image.publicUrl)}
