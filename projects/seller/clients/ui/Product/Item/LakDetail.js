...
import Title from "@itoa/ui/Title";
import TitleLak from "@itoa/ui/Title/Lak";
import FAQ from "@itoa/ui/FAQ";
...
import { refetchProductCart, refetchProductCartItem } from "../Cart/Item";
...
const LakDetail = ({
  ...
  const [currentImage, setCurrentImage] = useState(
    product?.image?.publicUrl.replace(/\/md/g, "") || "/assets/img/no-image.png",
  );
  ...
  const faq = useMemo(() => <FAQ UI={FAQSimple} />);
  return (
              ...
              <div className="col-12 col-md-6">
                ...
                {!product?.isOutOfStock && (
                  <div className="link-detail">
                    <a
                      className="add-to-c btnAddCart mt-3 w-100"
                      onClick={(e) => {
                        addToCart(e)
                          .then(({ data }) => {
                            console.log(data);
        ...
        <Fragment>
          <Tabs className="mt-5">
            <TabList>
              {product?.description && (
                <Tab>
                  <Translate content="Mô tả" />
                </Tab>
              )}
              {product?.detail?.publicUrl && (
                <Tab>
                  <Translate content="Chi tiết" />
                </Tab>
              )}
              {product?.guide && (
                <Tab>
                  <Translate content="Hướng dẫn" />
                </Tab>
              )}
            </TabList>
              ...
              {product?.detail?.publicUrl && (
                <TabPanel>
                  <Image
                    width={500}
                    height={500}
                    src={product?.detail?.publicUrl || "/assets/img/no-image.png"}
                    layout="responsive"
                  />
                </TabPanel>
              )}
